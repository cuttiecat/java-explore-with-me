...
public class MainCommonUtils {
    ...
    public static final int MIN_LENGTH_ANNOTATION = 32;
    public static final int MAX_LENGTH_ANNOTATION = 2048;
    public static final int MIN_LENGTH_DESCRIPTION = 16;
    public static final int MAX_LENGTH_DESCRIPTION = 8192;
